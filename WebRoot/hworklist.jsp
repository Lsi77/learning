...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper" style="margin-top: -14px">
		  <div class="header"> 
		  <form action="<%=Const.ROOT%>void/getHWlist" method="post">
		  <div class="row">
		  <div class="col-sm-6">
                    ...
                    <div class="card">
                        <div class="card-content">
                            <div class="table-responsive">
                                ...
                                <!--分页-->
                                <form action="<%=Const.ROOT%>void/getHWlist" method="post" id="Page">
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">发布教学作业</h4>
            </div>
            <!-- 新增 -->
