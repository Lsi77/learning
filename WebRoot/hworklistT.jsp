...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper" style="margin-top: -14px">
		  <div class="header"> 
		  <form action="<%=Const.ROOT%>void/getHWlist?role=3" method="post">
		  <div class="row">
		  <div class="col-sm-6">
                        <h1 class="page-header">
                           ...
                           <div class="col-sm-3">
                          		<div id="dataTables-example_filter" class="dataTables_filter">
                          		   <label>查询:<input type="search" name="voidname" value="${voidname }" class="form-control input-sm" placeholder="请输入作业名" aria-controls="dataTables-example">
                    ...
                    <div class="card">
                        <div class="card-content">
                            <div class="table-responsive">
                                            ...
                                            <td>${count.count }</td>  
                                              ...
                                              <td>${item.time }</td>
                                               ...
                                               <a class="waves-effect waves-light btn"  onclick="tolook('${item.id}')">
                            						查看</a>
                            					<a class="waves-effect waves-light btn" data-toggle="modal" data-target="#deleteModal" onclick="todel('${item.id}')">
                            						删除</a>	
                                ...
                                <!--分页-->
                                <form action="<%=Const.ROOT%>void/getHWlist?role=3" method="post" id="Page">
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">提交学生作业</h4>
            </div>
            <!-- 新增 -->
                        ...
                        <div class="card-content">
                         	<form class="col s12" action="<%=Const.ROOT%>void/updateVoid" method="post" enctype="multipart/form-data">
								...
								<div class="input-field col s12">
								  ...
								  <label for="textarea1">作业内容简介</label>
								</div>
							  </div>
    ...
    <label>
       ...
       <!--删除 -->
        ...
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="myModalLabel">删除作业</h4>
            </div>
...
function doPage(page){
	...
	function tolook(id){
		 location.href="${pageContext.request.contextPath }/void/lookHW/"+id;
	}
